...
func main() {
	...
	transactionHandler := handler.NewTransactionHandle(transactionService,paymentService)
	...
	api.POST("/transactions/notification", transactionHandler.ReceiveNotification)
